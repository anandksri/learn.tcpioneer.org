...
<strong>A key on my keyboard</strong>
<br> <br>
<img src="/assets/images/python/key.png"  alt="A key on my keyboard - TCP Handbook" style="max-width:100%; border-radius:6px;">
...
4. If you can't find what you're looking for or you still have trouble
   ...
   please [tell me about it]. I want to improve this
   tutorial so other readers won't have the same problem as you have.
5. See [Getting help] if you can't contact me for some
    reason.
