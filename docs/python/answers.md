...
isn't exactly like mine but it works just fine it's ok, and you can.
 why I didn't do it like you did it.
...
This Python tutorial section is inspired by the excellent work from the open-source project:  
https://github.com/Akuli/python-tutorial

We have adapted and structured the content to align with the TCP Handbook learning approach, focusing on clarity, practical understanding, and a better learning experience.

All credit for the original content and ideas goes to the respective authors and contributors of the project.
