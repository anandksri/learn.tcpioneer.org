...
<br> <br>
<img src="/assets/images/python/people.png"  alt="List of names - TCP Handbook" style="max-width:100%; border-radius:6px;">
...
<strong>Same list</strong>
<br> <br>
<img src="/assets/images/python/samelist.png"  alt="Same list - TCP Handbook" style="max-width:100%; border-radius:6px;">
...
<strong>Different list</strong>
<br> <br>
<img src="/assets/images/python/differentlist.png"  alt="Different list - TCP Handbook" style="max-width:100%; border-radius:6px;">
