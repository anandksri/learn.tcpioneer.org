...
<strong>Slicing with non-negative values</strong>
<br> <br>
<img src="/assets/images/python/slicing1.png"  alt="Slicing with non-negative values - TCP Handbook" style="max-width:100%; border-radius:6px;">
...
<strong>Slicing with negative values</strong>
<br> <br>
<img src="/assets/images/python/slicing2.png"  alt="Slicing with negative values - TCP Handbook" style="max-width:100%; border-radius:6px;">
...
<strong>Indexing with non-negative values</strong>
<br> <br>
<img src="/assets/images/python/indexing1.png"  alt="Indexing with non-negative values - TCP Handbook" style="max-width:100%; border-radius:6px;">
...
<strong>Indexing with negative values</strong>
<br> <br>
<img src="/assets/images/python/indexing2.png"  alt="Indexing with negative values - TCP Handbook" style="max-width:100%; border-radius:6px;">
...
<br> <br>
<img src="/assets/images/python/slicing3.png"  alt="Slicing - TCP Handbook" style="max-width:100%; border-radius:6px;">
...
<br> <br>
<img src="/assets/images/python/indexing3.png"  alt="Indexing  - TCP Handbook" style="max-width:100%; border-radius:6px;">
